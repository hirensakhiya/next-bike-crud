        ...
        <form className="max-w-sm mx-auto mt-20" onSubmit={handleSubmit(onSubmit)}>
            <div className="rounded overflow-hidden shadow-lg p-10 mt-5">
                ...
                <div className="mb-5">
                    ...
                    <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="name@flowbite.com" {...register("email", { required: "This field is required" })} />
                    {errors.email && (
